...
def test_complex_sql1():
    ...
    assert ret == {"type": "OR_SET", "children": ["VAR", {"type": "AND_SET", "children": ["VAR", "VAR"]}, {"type": "AND_SET", "children": ["VAR", "VAR"]}, {"type": "AND_SET", "children": ["VAR", "VAR"]}, {"type": "AND_SET", "children": ["VAR", "VAR"]}]}
...
def test_complex_sql2():
    ...
    assert ret == {"type": "OR_SET", "children": ["VAR", "VAR", {"type": "AND_SET", "children": ["VAR", "VAR", "VAR"]}, {"type": "AND_SET", "children": ["VAR", "VAR"]}, {"type": "AND_SET", "children": ["VAR", "VAR", "VAR"]}, {"type": "AND_SET", "children": ["VAR", "VAR"]}]}
...
def test_complex_sql3():
    ...
    assert ret == {"type": "OR_SET", "children": [{"type": "AND_SET", "children": ["VAR", "VAR", "VAR"]}, {"type": "AND_SET", "children": ["VAR", "VAR", "VAR"]}, "VAR", "VAR"]}
