...
#define LEAF_NODE_NEXT_SIBLING_SIZE  sizeof(uint32_t)
#define LEAF_NODE_NEXT_SIBLING_OFFSET  (CELL_NUM_OFFSET + CELL_NUM_SIZE)
#define LEAF_NODE_HEAD_SIZE  (COMMON_NODE_HEADER_SIZE + CELL_NUM_SIZE + LEAF_NODE_NEXT_SIBLING_SIZE)
...
#define INTERNAL_NODE_NEXT_SIBLING_SIZE sizeof(uint32_t)
#define INTERNAL_NODE_NEXT_SIBLING_OFFSET (KEYS_NUM_OFFSET + KEYS_NUM_SIZE)
#define RIGHT_CHILD_SIZE  sizeof(uint32_t)
#define RIGHT_CHILD_OFFSET  (KEYS_NUM_OFFSET + KEYS_NUM_SIZE + INTERNAL_NODE_NEXT_SIBLING_SIZE)
...
#define STRTAB_REFER_PAGE_SIZE sizeof(int32_t)
#define STRTAB_REFER_CELL_SIZE sizeof(int32_t)
#endif
