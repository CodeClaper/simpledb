...
MetaColumn SYS_TABLE_COLUMNS[] = {
    { SYS_TABLE_OID_NAME, T_LONG, SYS_TABLE_NAME, (LEAF_NODE_CELL_NULL_FLAG_SIZE + sizeof(int64_t)), 0, true, false, false, false, 0, 0},
    { SYS_TABLE_RELNAME_NAME, T_VARCHAR, SYS_TABLE_NAME, (LEAF_NODE_CELL_NULL_FLAG_SIZE + MAX_COLUMN_SIZE), 0, false, false, false, false, 0, 0},
    { SYS_TABLE_RELTYPE_NAME, T_INT, SYS_TABLE_NAME, (LEAF_NODE_CELL_NULL_FLAG_SIZE + sizeof(int32_t)), 0, false, false, false, false, 0, 0}
};
